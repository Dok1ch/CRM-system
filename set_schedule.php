...
if ($_SESSION['role_id'] == 3) {
    ...
    $resultTeacher = mysqli_query($connection, "SELECT * FROM users u, t_role r WHERE u.role_id = r.id_role AND r.role = 'Преподаватель' AND u.user_id = '$user_id'");
    $listTeacher = '<select class="form-control" name="teacher">';
    while ($teacher_array = mysqli_fetch_assoc($resultTeacher)) {
        $listTeacher .= '<option value="' . $teacher_array['user_id'] . '">' . $teacher_array['surname'] . ' ' . $teacher_array['name'] . ' ' . $teacher_array['patronymic'] . '</option>';
    }
...
if ($_SESSION['role_id'] == 3 or $_SESSION['role_id'] == 2) {
                        ...
                        <div class="form-group row text-left">
                            ...
                            <div class="col-sm-8 col-md-6 col-lg-6">
                                ...
                                <div class='input-group date'>
                                    <input type="datetime" class="form-control" id='datetimepicker1' name="date" onkeydown="return false"/>
