        ...
        <div class="text-center">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                ...
                while ($student_array = mysqli_fetch_assoc($result)) {
                    $table .= '<tr><td data-label="Фамилия:"><a class="link" href="../profile.php?user_id=' . $student_array['user_id'] . '">' . $student_array['surname'] . '</a></td>';
                    $table .= '<td data-label="Имя:"><a class="link" href="../profile.php?user_id=' . $student_array['user_id'] . '">' . $student_array['name'] . '</a></td>';
